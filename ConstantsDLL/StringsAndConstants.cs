...
namespace ConstantsDLL
{
    public static class StringsAndConstants
    {
        ...
        */
        ...
        public const string cliHelpTextServer = "Servidor do sistema de patrimônio (Ex.: 192.168.76.103, localhost, etc) - Opcional";
        public const string cliHelpTextPort = "Porta do sistema de patrimônio (Ex.: 8081, 80, etc) - Opcional";
        public const string cliHelpTextMode = "Tipo de serviço realizado (Valores possíveis: F/f para formatação, M/m para manutenção) - Opcional";
        public const string cliHelpTextPatrimony = "Patrimônio do equipamento (Ex.: 123456)";
        public const string cliHelpTextSeal = "Lacre do equipamento (se houver) (Ex.: 12345678 ou 'mesmo' para manter inalterado) - Opcional";
        ...
        public const string cliHelpTextActiveDirectory = "Cadastrado no Active Directory (Valores possíveis: Sim, Nao) - Opcional";
        public const string cliHelpTextStandard = "Padrão da imagem implantado no equipamento (Valores possíveis: F/f para funcionário, A/a para aluno) - Opcional";
        public const string cliHelpTextDate = "Data do serviço realizado (Valores possíveis: hoje, ou especificar data, ex.: 12/12/2020) - Opcional";
        ...
        public const string cliHelpTextInUse = "Equipamento em uso? (Valores possíveis: Sim, Nao) - Opcional";
        public const string cliHelpTextTag = "Equipamento possui etiqueta? (Valores possíveis: Sim, Nao)";
        public const string cliHelpTextType = "Categoria do equipamento (Valores possíveis: Desktop, Notebook, Tablet) - Opcional";
